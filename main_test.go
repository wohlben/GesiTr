...
func TestSetupRoutes(t *testing.T) {
	...
	expected := map[string]bool{
		...
		"GET /api/exercises/:id/versions/:version":    false,
		"DELETE /api/exercises/:id/versions/:version": false,
		"DELETE /api/exercises/:id/versions":          false,
		...
		"GET /api/equipment/:id/versions/:version":    false,
		"GET /api/user/exercise-schemes":              false,
		"POST /api/user/exercise-schemes":             false,
		"GET /api/user/exercise-schemes/:id":          false,
		"PUT /api/user/exercise-schemes/:id":          false,
		"DELETE /api/user/exercise-schemes/:id":       false,
