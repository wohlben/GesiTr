...
generate:
	...
	@{ \
		...
		for f in $(GEN_DIR)/shared.ts $(GEN_DIR)/exercise.ts $(GEN_DIR)/equipment.ts $(GEN_DIR)/exercise-group.ts $(GEN_DIR)/exercise-relationship.ts $(GEN_DIR)/equipment-fulfillment.ts $(GEN_DIR)/equipment-relationship.ts $(GEN_DIR)/workout-relationship.ts; do \
			tail -n +2 "$$f"; \
		done; \
	...
	@rm -f $(GEN_DIR)/shared.ts $(GEN_DIR)/exercise.ts $(GEN_DIR)/equipment.ts $(GEN_DIR)/exercise-group.ts $(GEN_DIR)/exercise-relationship.ts $(GEN_DIR)/equipment-fulfillment.ts $(GEN_DIR)/equipment-relationship.ts $(GEN_DIR)/workout-relationship.ts $(GEN_DIR)/user-workout.ts $(GEN_DIR)/user-workoutlog.ts $(GEN_DIR)/user-exerciselog.ts
