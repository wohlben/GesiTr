...
func ListUserExerciseSchemes(c *gin.Context) {
	db := database.DB.Model(&UserExerciseSchemeEntity{})
	...
	var entities []UserExerciseSchemeEntity
	if err := db.Find(&entities).Error; err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}

	dtos := make([]UserExerciseScheme, len(entities))
...
func CreateUserExerciseScheme(c *gin.Context) {
	...
	var userExercise UserExerciseEntity
	...
	entity := UserExerciseSchemeFromDTO(dto)
...
func GetUserExerciseScheme(c *gin.Context) {
	var entity UserExerciseSchemeEntity
...
func UpdateUserExerciseScheme(c *gin.Context) {
	var existing UserExerciseSchemeEntity
...
func DeleteUserExerciseScheme(c *gin.Context) {
	if err := database.DB.Delete(&UserExerciseSchemeEntity{}, c.Param("id")).Error; err != nil {
		c.JSON(http.StatusNotFound, gin.H{"error": "User exercise scheme not found"})
		return
	}
