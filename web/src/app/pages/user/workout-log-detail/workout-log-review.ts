            ...
            >
              <div class="flex items-center gap-2">
                <span
                  ...
                  "
                >
                  {{ t('enums.workoutSectionType.' + section.type) }}
                </span>
                @if (section.label) {
                  ...
                  <div class="mb-3 flex items-center justify-between">
                    <div class="flex items-center gap-2">
                      <span class="text-sm font-semibold text-gray-900 dark:text-gray-100">
                        {{
                          exerciseNames()[exercise.sourceExerciseSchemeId] || t('common.loading')
                        }}
                      </span>
                    ...
                    <span class="text-xs text-gray-500 dark:text-gray-400">
                      {{ t('enums.measurementType.' + exercise.targetMeasurementType) }}
                    </span>
                  </div>
                  ...
                  <div>
                    @for (set of exercise.sets; track set.id; let lastSet = $last) {
                      ...
                      @if (
                        ...
                        <div
                          class="break-indicator relative flex items-center justify-center py-0.5"
                        >
                          <div
