                            ...
                            <button
                              ...
                              [ngClass]="{
                                'bg-blue-50 dark:bg-blue-900':
                                  getParamValue(col.filterParam) === opt,
                              }"
                            >
                              {{ col.optionKeyPrefix ? t(col.optionKeyPrefix + '.' + opt) : opt }}
                            </button>
                          }
                        </div>
                      </div>
              ...
              @if (hideableColumns().length > 0) {
                <th class="w-8 bg-gray-50 px-2 py-2 dark:bg-gray-900">
                  <button
                    ...
                    [attr.aria-label]="t('ui.dataTable.columnSettings')"
                  >
      ...
      @if (showColumnSettings()) {
        ...
        >
          ...
          <div
            ...
            role="dialog"
            [attr.aria-label]="t('ui.dataTable.columnVisibility')"
          >
            <div class="mb-3 flex items-center justify-between gap-4">
              <h3 class="text-sm font-medium text-gray-900 dark:text-gray-100">
                {{ t('ui.dataTable.columns') }}
              </h3>
              <button
                type="button"
                (click)="showColumnSettings.set(false)"
